...
<tr><td>[?(@.key like 'aa%')]</td><td>字符串类型对象属性比较过滤，例如$.departs[?(@.name like 'sz*')]，比较操作符支持=,!=,>,>=,&lt;,&lt;= </td></tr>
<tr><td>[?(@.key in ('v0', 'v1'))]</td><td>字符串类型对象属性IN过滤，例如$.departs[?(@.name in ('wenshao','ljw2083'))]，比较操作符支持=,!=,>,>=,&lt;,&lt;= </td></tr>
